...
<html>
    ...
    <body style="background:url('img/240.png'); background-attachment: fixed; background-size: cover; background-repeat: no-repeat;">
        ...
        <div class="container" style="background-color: rgba(0, 0, 0, 0.7); border-radius: 100px; color: #fff; margin-top: 3%;">
            <br/><h1 class="form-signin-heading">Solicitud de Calculadoras Básicas</h1><br/><br/>
                ...
                <table class="table" style="margin:auto; background-color: #000; border-color: #444" border="1">
                    ...
                    <%
                        ...
                        for (int i = 0; i < lista.size(); i++) {
                            if (lista.get(i).getDisponible() && lista.get(i).getIdTipo() == 1 && id != lista.get(i).getIdPrestamista()) {
